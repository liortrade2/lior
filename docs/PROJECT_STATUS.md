...
### ⚠️ המודל הנוכחי (2026-06-12 בוקר) — חלש, זמני!
‏export חדש מהבוקר (`ES SEP26`, ינו–יוני 2026) דרס את מודל ה-239 באימון
אוטומטי: **43 עסקאות בלבד, אין walk-forward** ‏(PMV ‏0.725 על דגימה זעירה
— לא אמין). חלון: 09:45–13:30 ET. **הצעד הקריטי הבא: בקטסט עם ההגדרות
הנוכחיות על ינואר 2024→היום + export** — יחזיר נפח (200+) עם פרופיל
השעות החדש. עד אז ציונים חיים בערבון מוגבל.
